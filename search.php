<?php
    ...
    if (isset($_GET['key'])) {
        ...
        // jalankan query
        $show = mysqli_query($connect, "SELECT * FROM product WHERE  name LIKE '%$key%' OR description LIKE '%$key%' ORDER BY id");
        $keyString = $key;
    }else{
        $show = mysqli_query($connect, "SELECT * FROM product ORDER BY id");
        $keyString = "semua produk";
    }
?>
<!DOCTYPE html>
<html lang="en">
...
<body data-spy="scroll" data-target="#myScrollspy" data-offset="15">
    ...
    <section id="portfolio" class="bg-light-gray">
        ...
        <div class="row">
            <center><p>kata kunci '<?php echo $keyString ?>'</p></center>
        </div>
        <div class="row">
